...
var de = (e, t) => {
	...
	for (let t = 0; t < n; t++) {
		...
		for (; u < n.length && (o.lastIndex = u, c = o.exec(n), c !== null);) u = o.lastIndex, o === A ? c[1] === "!--" ? o = j : c[1] === void 0 ? c[2] === void 0 ? c[3] !== void 0 && (o = N) : (ce.test(c[2]) && (i = RegExp("</" + c[2], "g")), o = N) : o = M : o === N ? c[0] === ">" ? (o = i ?? A, l = -1) : c[1] === void 0 ? l = -2 : (l = o.lastIndex - c[2].length, s = c[1], o = c[3] === void 0 ? N : c[3] === "\"" ? F : P) : o === F || o === P ? o = N : o === j || o === M ? o = A : (o = N, i = void 0);
...
_e?.(H, W), (v.litHtmlVersions ??= []).push("3.3.3");
var ve = (e, t, n) => {
...
var Y = (e, t, n) => (n.configurable = !0, n.enumerable = !0, Reflect.decorate && typeof t != "object" && Object.defineProperty(e, t, n), n);
//#endregion
...
//#endregion
//#region lib/core/utils/element.ts
var Ee = class extends q {}, De = (e) => o`
  ${a(e)}
`;
//#endregion
...
//#endregion
//#region lib/core/icon/base-icon.scss?inline
var Ae = ":host{display:flex}.base{box-sizing:content-box}.primary{color:var(--icon-color-primary)}.secondary{color:var(--icon-color-secondary)}.info{color:var(--icon-color-info)}.success{color:var(--icon-color-success)}.warning{color:var(--icon-color-warning)}.critical{color:var(--icon-color-critical)}.inverse{color:var(--icon-color-inverse)}.theme{color:var(--icon-color-theme)}.sm{width:var(--icon-size-sm);height:var(--icon-size-sm)}.md{width:var(--icon-size-md);height:var(--icon-size-md)}.lg{width:var(--icon-size-lg);height:var(--icon-size-lg)}.featured{background-color:var(--icon-featured-base-background-color);border-radius:var(--icon-featured-base-border-radius);padding:var(--icon-featured-md-padding);justify-content:center;align-items:center;display:flex}.featured.sm{padding:var(--icon-featured-sm-padding)}.featured.md{padding:var(--icon-featured-md-padding)}.featured.lg{padding:var(--icon-featured-lg-padding)}";
//#endregion
...
//#endregion
//#region lib/core/icon/base-icon.ts
var Z = class extends Ee {
	...
	get class() {
		return ke(this.size && `${this.size}`, this.variant && `${this.variant}`);
	}
	render() {
		return this.featured ? I`<span class="featured">${this.svg}</span>` : this.svg;
	}
};
X([J({
	type: String,
	reflect: !0
})], Z.prototype, "size", void 0), X([J({
	type: String,
	reflect: !0
})], Z.prototype, "variant", void 0), X([J({ type: Boolean })], Z.prototype, "featured", void 0);
//#endregion
//#region node_modules/lit-html/directives/if-defined.js
var je = (e) => e ?? R, Q = Symbol.for(""), Me = (e) => {
	...
	r: Q
}), $ = /* @__PURE__ */ new Map(), Fe = ((e) => (t, ...n) => {
	let r = n.length, i, a, o = [], s = [], c, l = 0, u = !1;
	for (; l < r;) {
		for (c = t[l]; l < r && (a = n[l], i = Me(a)) !== void 0;) c += i + t[++l], u = !0;
...
//#endregion
export { I as _, Z as a, a as b, De as c, we as d, Ce as f, R as g, q as h, je as i, Ee as l, be as m, Ne as n, X as o, J as p, Fe as r, ke as s, Pe as t, Te as u, ue as v, o as y };
